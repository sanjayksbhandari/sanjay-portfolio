...
export const engineeringStrengths: EngineeringStrength[] = [
  {
    ...
    explanation:
      "Architected two production platforms from the ground up at Opal BPM: the 16-microservice Enterprise Exchange Platform and the company's core Artwork Management Platform.",
  ...
  },
  {
    ...
    explanation:
      "Designed the Kafka-based order-to-settlement event flow behind a multi-tenant trading platform running in production at 99.9% uptime, with notification delivery under 100ms.",
    relatedCaseStudySlug: "enterprise-exchange-platform",
  },
  {
    ...
    explanation:
      "Led the design and rollout of a standardized OAuth2 authentication and authorization model across multiple independent client deployments.",
  ...
  },
  {
    ...
    explanation:
      'Built an RFC 1.2.0-compliant Beckn adapter ("WRI Connector") integrating 5+ identity-verification providers behind one interface, at sub-50ms P95 latency.',
  ...
  },
  {
    ...
    explanation:
      "Grew from Opal BPM's second employee into its Lead Java Developer over nine-plus years, mentoring a team of 5–7 developers and setting its code-quality and system-design standards.",
